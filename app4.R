...
while (sigma1_2<=2.25){
  while (sigma2_2<=2.25){
    ...
    k=k+1
    sigma2_2=sigma2_2+0.7
  }
  sigma1_2 = sigma1_2+0.7
  sigma2_2 = 0.15
}

matrix_f_m = matrix(f_m, nrow = 4, byrow = TRUE)
matrix_f_10= matrix(f_10, nrow = 4, byrow = TRUE)
matrix_f_90= matrix(f_90, nrow = 4, byrow = TRUE)
