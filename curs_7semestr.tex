...
Построим графики \ref{ris7}, \ref{ris8} и \ref{ris9}. зависимости ошибки аппроксимации квантилей от $\sigma_{2}^{2}$ при фиксированной $\sigma_{1}^{2} = 0.45$.
...
\begin{table}[!hhh]
	...
	\begin{tabular}{rrrrr}
		...
		\textbf{0.55} & 0.49 & 0.50 & 0.48 & 0.46 \\ 
...
\begin{table}[!hhh]
	...
	\begin{tabular}{rrrrr}
		...
		\textbf{0.55} & 0.05 & 0.08 & 0.06 & 0.04 \\ 
...
\begin{table}[!hhh]
	...
	\begin{tabular}{rrrrr}
		...
		\textbf{0.55} & 0.93 & 0.90 & 0.91 & 0.91 \\ 
