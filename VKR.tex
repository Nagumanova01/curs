...
Мы пришли к тому, что аппроксимировать логнормальное распределение можно при ограниченных значениях параметра $\sigma$, достаточно маленьких. Остается вопрос, что делать при $\sigma$, не удовлетворяющих условию для существования трехточечной симметричной аппроксимации.
