	...
	\begin{figure}[!hhh]
		\begin{center}
			\begin{minipage}[h]{0.8\linewidth}
				...
				\caption{Плотность логнормального с параметрами $\mu = 0$, $\sigma = 1.5$. } %% подпись к рисунку
	...
	\begin{figure}[!hhh]
		\begin{center}
			\begin{minipage}[h]{0.8\linewidth}
				...
				\caption{Плотность логнормального с параметрами $\mu = 0$, $\sigma = 0.69$. } %% подпись к рисунку
...
Мы пришли к тому, что аппроксимировать логнормальное распределение трехточечным вероятностным распределением можно при ограниченных значениях параметра $\sigma$, достаточно маленьких. Остается вопрос, что делать при $\sigma$, не удовлетворяющих условию для существования трехточечной симметричной аппроксимации.
	...
	\begin{thebibliography}{1}
		...
		\bibitem{AAA} Нагуманова Карина (2023). Замена непрерывного распределения на дискретное. https://doi.org/10.5281/zenodo.7963595.
